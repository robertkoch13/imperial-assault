package com.robertkoch.imperialassault.persistence.config;
...
@EnableJpaRepositories("com.robertkoch.imperialassault.persistence")
public class JPAConfig {
    ...
    private static final String PROPERTY_NAME_HIBERNATE_DIALECT = "jdbc.dialect";
